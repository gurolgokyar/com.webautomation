...
public class ConstantMovementPageTest extends Hooks {
	...
	public void testConstantMovementPage() throws InterruptedException {
		...
		softAssertions.assertEquals(initialX, finalX);
		...
		softAssertions.assertEquals(finalY, initialY);
		...
		pages.getConstantMovementPage()
			.dragAndDrop(pages.getConstantMovementPage().getDraggable3(), -widthOfBiggestBox, -heightOfBiggestBox);
		...
		softAssertions.assertTrue(XOfBiggestBox < finalXOfDraggable3);
		...
		softAssertions.assertTrue(YOfBiggestBox < finalYOfDraggable3);
		...
		softAssertions.assertTrue(XOfDraggable5 < finalXOfDraggable4);
		...
		softAssertions.assertTrue(upperYOfDraggable5 < finalYOfDraggable4);
