...
public class HandlesPageTest extends Hooks {
	...
	void testDraggable1WithDraggableArea() throws InterruptedException {
		...
		assertTrue(initialXOfDraggable < finalXOfDraggable,
				"Attempted draggable1 to drag by draggable area and " + "draggable did not remove");
		assertTrue(initialYOfDraggable < finalYOfDraggable,
				"Attempted draggable1 to drag by draggable area and " + "draggable did not remove");
	...
	void testDraggable1WithUnDraggableArea() throws InterruptedException {
		...
		assertEquals(initialXOfDraggable, finalXOfDraggable,
				"Attempted draggable1 to drag by undraggable area and " + "draggable removed");
		assertEquals(initialYOfDraggable, finalYOfDraggable,
				"Attempted draggable1 to drag by undraggable area and " + "draggable removed");
	}
	...
	void testDraggable2WithDraggableArea() throws InterruptedException {
		...
		assertTrue(initialXOfDraggable < finalXOfDraggable,
				"Attempted draggable2 to drag by draggable area and " + "draggable did not remove");
		assertTrue(initialYOfDraggable < finalYOfDraggable,
				"Attempted draggable2 to drag by draggable area and " + "draggable did not remove");
	...
	void testDraggable2WithUnDraggableArea() {
		...
		assertEquals(initialXOfDraggable, finalXOfDraggable,
				"Attempted draggable2 to drag by undraggable area and " + "draggable removed");
		assertEquals(initialYOfDraggable, finalYOfDraggable,
				"Attempted draggable2 to drag by undraggable area and " + "draggable removed");
	}
